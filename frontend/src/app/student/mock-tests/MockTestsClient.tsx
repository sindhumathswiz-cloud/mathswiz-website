    ...
    return (
        <div className="p-6 md:p-10 max-w-5xl mx-auto">
            <div className="mb-8">
                ...
                <p className="text-slate-500 font-medium text-sm">Exam-style, timed, full-lockdown practice tests to simulate real conditions.</p>
            </div>

            {assignments.length === 0 ? (
                <div className="text-center py-16 border-2 border-dashed border-gray-200 rounded-2xl">
                    <ClipboardList className="w-12 h-12 text-gray-300 mx-auto mb-3" />
                    <p className="text-gray-500 font-medium">No mock exams assigned yet.</p>
                </div>
            ) : (
                    ...
                    {assignments.map((assignment: any) => {
                        ...
                        return (
                            <div key={assignment.id} className="border border-gray-200 rounded-2xl p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 hover:shadow-md transition">
                                <div>
                                    <div className="flex items-center gap-2 mb-2">
                                        <span className="text-[10px] font-black uppercase tracking-widest px-2.5 py-1 rounded-lg bg-indigo-100 text-indigo-700">Mock Exam</span>
